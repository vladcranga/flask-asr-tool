...
def start_recording():
    ...
    return jsonify({'status': 'recording' if recording else 'paused' if paused else 'stopped'})
...
def generate_spectrogram():
    try:
        ...
        plt.specgram(audio_data, NFFT=256, Fs=sample_rate, cmap='viridis', aspect='auto')
        plt.axis('off')
        ...
        return send_file(img_data, mimetype='image/png', as_attachment=True, download_name='spectrogram.png')
