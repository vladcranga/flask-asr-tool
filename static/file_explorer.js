document.addEventListener("DOMContentLoaded", function () {
  ...
  function displaySpectrogram(audioFileURL) {
    ...
    const canvasContainer = spectrogramContainer.querySelector(
  ...
  function displayAudioTranscription(fileName) {
    ...
    const transcriptionContainer = document.querySelector(
    ...
    const saveTranscriptionButton =
      document.getElementById("save-transcription");
  ...
  document
    .getElementById("save-transcription")
    .addEventListener("click", function () {
      const transcriptionTextarea = document.getElementById("transcription");
      const transcriptionText = transcriptionTextarea.value;
      if (
        transcriptionText.trim() === "" ||
        transcriptionText.trim() === "Processing..."
      ) {
